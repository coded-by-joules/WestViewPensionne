...
<head>
    ...
    <title>Westview Pensione House - Cebu | Promotions</title>
...
<body>
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
            <div class="col-lg-12">
               <div class="page-header">
                ...
                <p>Have a more delightful vacation by grabbing any of Westview Pension House's Cebu City promos and packages for its rooms in the Queen City of the South. 
                </p>
                </div>
                 <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="hotelpage/images/promo-banner.jpg" alt="">
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-lg-12">
               <center><h2 class="page-header">Promos  <i class="fa fa-fw fa-gift " style="color:red;"> </i> </h2></center> 
            </div>
            <?php
 //Promo Section :)
  include('connection.php');
  ...
  $date = $d->format('Y-m-d');
    ...
    {
      if ($row['Status']=='Available' && $row['Discount']!=0)
      {
        if ($date<$row['Date_End']) {
            echo '<div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
                    
                      <div class="promo-member">
                       <img src="adminpage/room/'.$row['Image'].'" class="img-responsive" alt="" >
                    </div>
                    ...
                    <p>Room type: '.$row['CategoryName'].'</p>
                    <p>Rate: ₱ '.$row['Rate'].'</p>
                    <p>Discount: '.$row['Discount'].'%</p>
                    <p>Date Start: '.$row['Date_Start'].'</p>
    ...
    ?>
             ...
             <div class="row">
            <div class="col-lg-12">      
               <a class="btn btn-promo4 btn-lg btn-block" target="_blank" href="index.php"> Check availaibility and prices <i class="fa fa-fw fa-search  "> </i></a>
            </div>
            </div>   
        </div>
