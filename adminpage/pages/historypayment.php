...
<body>
   ...
   <ul class="nav navbar-top-links navbar-right">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">History of Payment</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <table class="table table-hover" style="width:900px; margin-left:50px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php 
                                            $sql = "SELECT tblusers.FirstName, tblusers.LastName, tblreservation.Arrival,tblreservation.Departure,tblreservation.Status,tblreservation.Payable  FROM tblreservation 
                                            INNER JOIN tblusers ON tblreservation.Customer_ID=tblusers.Customer_ID Where tblreservation.Status='Check Out' ORDER BY tblusers.LastName ASC";
