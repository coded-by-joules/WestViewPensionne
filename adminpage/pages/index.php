...
include('../../connection.php');
$curdate=date("Y-m-d");
$sql="delete from tblreservation where DATE_ADD('ReservationDate', INTERVAL 3 DAY) as Tommorrow='".$curdate."' And Status='Pending'";
...
<head>
    ...
    <title>Westview Pension House | Admin Page</title>
...
<body >
    ...
    <div style="background-color: rgb(44, 115, 231);" id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right">
                   <li class="dropdown" >
                    ...
                    <a href="#"  data-toggle="modal" data-target="#report">
                        <i class="fa fa-share-square-o  fa-fw"></i>Generate Sales Report
                    </a>
                <li class="dropdown">
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
                 ...
                 <div class="form-group" style="margin-top:-150px; margin-left:350px;">
    ...
    <!-- /#wrapper -->
                                ...
                                <div class="modal fade" id="report" tabindex= role="dialog" aria-labelledby="roomClabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="roomClabel">Generate Report</h4>
                                        </div>
                                  
                                        <div class="modal-body">
                                        <div class="form-group">
                                      <form method="post" action="../room/monthlyincome.php" >
                                        Year
