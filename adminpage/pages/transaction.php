...
include('../../connection.php');
$curdate=date("Y-m-d");
$sql="delete from tbltransaction where DATE_ADD('DateReserve', INTERVAL 3 DAY) as Tommorrow='".$curdate."' And Status='Pending'";
...
<body>
   ...
   <div style="background-color: rgb(44, 115, 231);" id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                         <a href="../pages/transaction.php" class="active"><i class="fa fa-shopping-cart"></i>Transaction</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-13">
                    <h1 class="page-header"><i class="fa fa-shopping-cart"> </i> Transaction</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                        <!-- /.panel-body -->
                ...
                <div class="col-lg-13">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Transaction Details for Guest Reservation 
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="dataTable_wrapper" style="overflow:auto">
                               ...
                               <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:1800px;">
                                    <thead>
                                       <th>FirstName</th>
                                            <th>LastName</th>
                                             <th>Room Number</th>
                                    ...
                                    $sql = "select tblusers.Customer_ID,tbltransaction.Reservation_ID,tblreservation.Status,tblreservation.Confirmation,tblreservation.Downpayment,tblreservation.AddonPayable,tblusers.FirstName,tblusers.LastName,tbltransaction.DateReserve,tbltransaction.DateIn,tbltransaction.DateOut,tbltransaction.DateOut,tbltransaction.UserInCharge,tbltransaction.Amount,tblreservation.CategoryName,tblreservation.Room_ID,tblreservation.Status 
                                        ...
                                        while ($row = $dresult->fetch_assoc()) {
                                            ...
                                            $departure=date_create($row['DateOut']);
                                               ...
                                               else
                                               {
                                                ...
                                                echo  "<td>₱ ".$row["Downpayment"]. ".00</td>
                                                <td>₱ ".$row["AddonPayable"].".00 </td>
                                               ...
                                               {
                                                 echo "<td><a href='#' class=' btn btn-success' >Add on</a></td>";
                                               }
                                                if ($row['Status']!="Check Out" && $row['Status']!="Cancelled")
                                               {
                                               echo "<td><a href='../room/roomtransferdetails.php?rid=".mysqli_real_escape_string($conn, $row['Reservation_ID'])."' value=".$row['Room_ID']."' class='btn btn-danger transfer' >Transfer Room</a></td>";
                                               }
                                               else
                                               {
                                                echo "<td><a href='#' class='btn btn-danger transfer' >Transfer Room</a></td>";
                                               }
                                               ...
                                               echo "<td><a href='../CustomerReservation/transaction2.php?confirmation=".$row['Confirmation']."' onclick=' return UpdateCheckout()'   class='btn btn-primary action'>Check Out</a></td>";
                                                ...
                                                echo "<td><a href='../pages/viewtransaction.php?confirmation=".$row['Confirmation']."'    class='btn btn-primary action'>View</a></td>";
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper" style="overflow: auto">
                                <table class="table table-\striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php 
                                    include("../../connection.php");
                                    $sql = "select * from tblroomtransfer ";
                                    $result = $conn->query($sql);
                                    if ($result->num_rows>0) {
                                        while ($row = $result->fetch_array()) {
                                            echo "<tr>
                                              ...
                                              <td> ".$row["Status"]. "</td>
                                              <td> ".$row["UserInCharge"]. "</td>   
                                              <td><a onclick='deleteTransfer(".$row['transfer_id'].")' class='btn btn-danger' data-toggle='modal' data-target='#deltransfer'>Delete</a></td>
                                            </tr>";
                                        }
                                    }
                                    ?>
                            ...
                            <!-- /.table-responsive -->
                             <!--delete modal-->
                                            <div class="modal fade" id="deltransfer" tabindex="-1" role="dialog" aria-labelledby="deleteLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        ...
                                        <div class="modal-footer">
                                           <?php  echo "<button type='button' class='btn btn-default' data-dismiss='modal'>Cancel</button>
                                             <button id='deletetransfer' type='button'  class='btn btn-primary' data-dismiss='modal'>Yes</button>";?>
                                        </div>
                                    </div>
                                    <!-- /.modal-delete -->
                                </div>
