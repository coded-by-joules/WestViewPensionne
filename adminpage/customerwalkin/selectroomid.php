...
if ($searchroomid=="")
{
   echo "<div>";   
    ...
    echo "<p><select class='form-control' name='status' id='status' class='text'><option></option></select></p>";
    echo "</div>";   
   }
else
{
...
$sql="select tblcategories.CategoryName, 
 ...
 $result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
    ...
    echo "<div>";   
    echo "<p><input class='form-control' type='text' name='categoryname' id='categoryname' class='text' value=".$row['CategoryName']."></p>";
    echo "<p><input class='form-control' type='text' name='amount' id='amount' class='text'   value=".$row['Rate']." readonly></p>";
    echo "<p><select class='form-control'  name='status'  class='text'><option>$row[Status]</option></select></p>";
}   echo "</div>";
