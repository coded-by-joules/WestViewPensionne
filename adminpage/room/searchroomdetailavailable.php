...
include("../../connection.php");
    if ($_POST)
    { 
    $fromdate=$_POST['availablesearchstartdate']; 
    $todate=$_POST['availablesearchenddate']; 
      ...
      OR Departure >= '".$searchstartdate."' AND Arrival <= '".$searchenddate."') ORDER by tblrooms.Date_Start ASC";
                                ...
                                echo "<table class='table table-striped'>";
                                  ...
                                  if ($row['Date_End']=="" || $row['Date_Start']=="0000-00-00" )
                                    ...
                                    echo "<td>><img id='imagelist' style='border: thin solid silver;float: left;padding: 5px;width: 70px;height: 70px;margin: 0 5px 0 0;' src=".$row['Image']. "></td>
                                     </tr></tbody></table>
                                     </div>
                                     </div>";
                                   }
