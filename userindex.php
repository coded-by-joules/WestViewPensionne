    ...
    <div class="container" style="margin-top:65px;">
            ...
            <div class="col-lg-12">
                ...
                <p>
                   This section defines your profile details , feel free to update your account ! 
                    <b><a href="./myhistory.php">My History of Reservation</a></b>
                </p>
                </div>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-4">
             ...
             <div class="col-lg-5">
                <blockquote style="border-color:#4988F0">
                    <div class="form-group">
                     
                        <form action="actions/changepassword.php" method="POST">   
                                            <label>Old Password</label>
                                            <input class="form-control" value="<?php echo $user_check ?>" name="oid" type="hidden" required>
                                           <input id="pass" class="form-control" placeholder="Old Password" name="oldpassword" type="password" required>
                                        </div>
                                        <div class="form-group">
                                            <label>New Password</label>
                                            <input id="pass" class="form-control" placeholder="New Password" name="newpassword" type="password" required>
