...
<head>
    ...
    <title>Westview Pensione House - Cebu | Room - Familly Double </title>
   ...
   <!--Modal Login-->
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item">
                            <img class="img-responsive" src="hotelpage/images/sliderimages/familly_dou2750x500.jpg" alt="">
                        </div>
                        <div class="item active">
                            <img class="img-responsive" src="hotelpage/images/sliderimages/familly_dou750x500.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <h3>Familly Double</h3>
                <p>Expect such amenities and services with your stay: </p>
                <p><span class="fa fa-tag " style="color:red;"></span> Smoking and non-smoking rooms</p>
                <p><span class="fa fa-tag " style="color:red;"></span> Two Familly Bed size</p>  
                <p><span class="fa fa-tag " style="color:red;"></span> 32-inch cable TV</p>
                <p><span class="fa fa-tag " style="color:red;"></span> Broadband Internet access</p>
                <p><span class="fa fa-tag " style="color:red;"></span> 24-hour room service</p>
                <p><span class="fa fa-tag " style="color:red;"></span> Hair dryer and phone</p>
                <p><span class="fa fa-tag " style="color:red;"></span> Daily delivery of local newspaper</p>
                <p><span class="fa fa-tag " style="color:red;"></span> Fully Aircondition</p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h3 class="page-header">Room Types</h3>
            </div>

            <div class="col-sm-3 col-xs-6">
                <a href="room.php">
                    <img class="img-responsive img-hover img-related" src="hotelpage/images/sliderimages/petit3-500x300.jpg" alt="">
                </a><label>Petit</label>
            </div>

            <div class="col-sm-3 col-xs-6">
                <a href="room-standard-deluxe.php">
                    <img class="img-responsive img-hover img-related" src="hotelpage/images/sliderimages/standard-500x300.jpg" alt="">
                </a><label>Standard Deluxe</label>
            </div>

            <div class="col-sm-3 col-xs-6">
                <a href="room-full-deluxe.php">
                    <img class="img-responsive img-hover img-related" src="hotelpage/images/sliderimages/full-500x300.jpg" alt="">
                </a><label>Full Deluxe</label>
            </div>

            <div class="col-sm-3 col-xs-6">
                <a href="room-familly-standard.php">
                    <img class="img-responsive img-hover img-related" src="hotelpage/images/sliderimages/fam_standard500x300.jpg" alt="">
                </a><label>Familly Standard</label>
            </div>
                ...
                <div class="col-lg-6">
                 ...
                 <div class="col-lg-6">
                    <div class="text-right">
                     Social Accounts: <a href="http://www.facebook.com/" class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>
