...
<head>
    ...
    <title>Westview Pensione House - Cebu | Room - Full Deluxe </title>
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="hotelpage/images/sliderimages/full-750x500.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <p><span class="fa fa-tag " style="color:red;"></span> Standard Bed size</p>  
