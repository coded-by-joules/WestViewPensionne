...
<body>
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Westview Pension House - Location
                </h3>
                <p>
                    Macopa St., Kinasang-an Pardo, Cebu City Philippines 
                </p>
                <p>
                    Among the attractions close to this Cebu City hotel are:

                    Shopping Centers
                    Ayala Center, Century Plaza, Colonnade Mall, Duty Free Philippines, Gaisano Main, Rivergate Mall, Robinson Place, Rustan’s Department Store, SM City Cebu
                    Business and financial districts
                    Cebu Business Park, Mactan Export Processing Zone
                    Hospitals
                    PNP Hospital, St. Anthony Mother and Child Hospital, Guba Community Hospital
                    Centers of tourism and culture
                    Magellan’s Cross, Fort San Pedro, Plaza Independencia, Basilica Minore del Santo Niño, Taoist Temple, beaches

                </p>
                <p>
                    Public transport options, like jeepneys, pedicabs, taxis, and tricycles, can easily be found within the vicinity of this Cebu City hotel.
                </p>
                 <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <!-- Embedded Google Map -->
                <iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.here.com/philippines/cebu-city/accommodation/west-view-pension--608wcb4d-2a26c5c2ce8140b89f67590dcf95b9f3?map=10.29251,123.86659,17,normal"></iframe>
            </div>
            ...
            <div class="col-md-4">
                ...
                <p>
                    Macopa St<br>
                    Kinasang-an Pardo<br>
                    Cebu City<br>
                    Philippines
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: +63(32)2727993</p>
