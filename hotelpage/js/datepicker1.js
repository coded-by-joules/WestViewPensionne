...
//resultElem.value = Math.round(Math.abs((dt1.getTime() - dt2.getTime())/(oneDay)));
resultElem.value = (dt2.getTime() - dt1.getTime()) / (24 * 60 * 60 * 1000); //hours*minutes*seconds*milliseconds
}