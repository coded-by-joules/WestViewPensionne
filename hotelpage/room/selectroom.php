...
<head>
    ...
    <!--Icon-->
    <link href="../../images/westview.png" type="image/png" rel="icon">
    <!-- Custom CSS -->
    <link href="../css/modern-business.css" rel="stylesheet">
    <link href="../css/westview.css" rel="stylesheet">
  ...
  <SCRIPT language=Javascript>
      ...
      {..
         var charC..ode = (evt.which) ? evt.which : event.keyCode
...
<body>
    ...
    $numberofdays = $_POST['numberofdays'];
      ...
      $date = $d->format('d/m/Y');
      $arrival = $s->format('d/m/Y');
      $departure = $e->format('d/m/Y');
?>
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
         ...
         <!-- /input-group -->   
                ...
                <ol class="breadcrumb">
                    <?php 
                        echo "<li style='font-weight:bold;'>Arrival : </li>" ." ". $from; 
                        echo "<li style='font-weight:bold;'>Departure :</li>" ." ". $to;
                        echo "<li style='font-weight:bold;'>Nights :</li>" ." ". $numberofdays;  
                    ?>
        ...
        $sql="select tblrooms.Room_ID, tblcategories.CategoryName, 
          ...
          OR tblreservation.Departure >= '$arrival' AND tblreservation.Arrival <= '$departure' 
          Union
          select Room_ID from tblwalkins WHERE Customer_ID is null
          OR Departure >= '".$arrival."' AND Arrival <= '".$departure."') ";
        ...
        <!-- Blog Post Row -->
            ...
            <div class='col-md-6'>
                ...
                <p class='tooltip-demo'> <a href='#' class='btn btn-default btn-xs' data-toggle='modal' data-target='#".$row['CategoryName']."".$row['Room_ID']."'><i class='fa fa-search-plus ''></i> More information </a> ";
                if (isset($_SESSION['Customerid'])) {
                    echo "<button value='".$row['Room_ID']."'  id='reserve' class='btn btn-promo4 btn-xs' data-toggle='modal' data-target='#bookit'><i class='fa fa-check'></i> Book it</button>";
                } else {
                    echo '<a href="#portfolioModal1" class="btn btn-promo4 btn-xs" data-toggle="modal"  ><i class="fa fa-check"></i> Book it</a></p>';
                }
                echo "<p><ul class='nav'>
        ...
        <hr>";
        echo "<div class='portfolio-no-modal modal fade'  tabindex='-1' role='dialog' aria-hidden='true'>";
        ?>
                            ...
                            <div class="tab-content">
                                ...
                                <img class="img-responsive " src="<?php echo 'adminpage/room/' .$row["Image"] . '';?>" alt="">
        ...
        <div class="room-modal modal fade" id="<?php echo $row['Room_ID'].''.$row['No_child'];?>" tabindex="-1" role="dialog" aria-hidden="true">
            <div style="background-image: url(&quot;<?php echo 'adminpage/room/' .$row["Image"] . '';?>&quot;); background-size: 100% 100%; background-repeat: no-repeat;" class="modal-content">
    ...
    <div class="modal fade" id="bookit" tabindex="-1" role="dialog" aria-labelledby="deleteLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    <h4 class="modal-title" id="deleteLabel">Note: Reserve this Room</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                <p><label>Do you want to Reserve this room?</label></p>
                                <div id="searchroomid">
                                </div>
                            </div>
                            </div>
    ...
    <script src="../../adminpage/dist/js/selectroom.js"></script>
