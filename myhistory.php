    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h3>
                Hello - <?php echo ucfirst($row["FirstName"]);?>
                </h3>
                <p>
                   This section defines your profile details , feel free to update your account ! 
                    <b><a href="./userindex.php">Back to my Profile</a></b>
                </p>
                </div>
                <ol class="breadcrumb">
                    <li><a href="index.php">Go back Home</a>
                            ...
                            <div class="dataTable_wrapper" style="overflow:auto">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:1500px;">
                                    <thead>
                                            <th>FirstName</th>
                                            <th>LastName</th>
                                            <th>Room_ID</th>
                              ...
                              <?php 
                                    ...
                                    $sql = "select tblreservation.Reservation_ID, tblreservation.Confirmation,tblusers.FirstName, tblusers.LastName, tblusers.Contact,tblusers.Email,
                                            ...
                                            INNER JOIN tblrooms ON tblrooms.Room_ID=tblreservation.Room_ID Where tblusers.Customer_ID='".$user_check."'
                                           ";
                                    $result = $conn->query($sql);
                                    ...
                                    $departure=date_create($row['Departure']);    
                                            echo "<tr>
                                                ...
                                                {
                                                echo "<td><a href='login.php?confirmation=".$row['Confirmation']."'class='btn btn-primary action'>Pay Now</a></td>";
                                                }
                                                else
                                                {
                                                    echo "<td><a class='btn btn-primary action'><span>Pay Now</span></a></td>"; 
                                                }
   ...
   <script src="hotelpage/js/jquery.js"></script>
    ...
    function reserveDelete(id) {
      $("#delreserve").click(function(e){
        window.location='./adminpage/room/deletereserve.php?resid='+ id;
      });
    }
    </script>
