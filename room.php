...
<head>
   ...
   <title>Westview Pensione House - Cebu | Room - Petit </title>
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="hotelpage/images/sliderimages/petit-750x500.jpg" alt="">
                        </div>
            ...
            <div class="col-md-4">
                ...
                <p><span class="fa fa-tag " style="color:red;"></span> Couple Bed size</p>  
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-xs-6">
                <a href="room-full-deluxe.php">
                    <img class="img-responsive img-hover img-related" src="hotelpage/images/sliderimages/full-500x300.jpg"alt=""></a><label>Full Deluxe</label>
            </div>
