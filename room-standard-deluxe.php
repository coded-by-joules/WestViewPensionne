...
<head>
    ...
    <title>Westview Pensione House - Cebu | Room - Standard Deluxe</title>
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="hotelpage/images/sliderimages/standard-750x500.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <p><span class="fa fa-tag " style="color:red;"></span> 14-inch cable TV</p>
                ...
                <div class="col-lg-6">
                 ...
                 <div class="col-lg-6">
                    <div class="text-right">
                       ...
                       Social Accounts: <a href="http://www.twitter.com/" class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>
