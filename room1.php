...
<head>
    ...
    <title>Westview Pensione House - Cebu | Room</title>
 ...
 <?php
                    ...
                    <div class="panel-body">
                        <form role="form" method="POST" action="">
                            <fieldset>
                                ...
                                <input class="btn btn-lg btn-promo2 btn-block" name="submit" type="submit" value="Sign In" />
                                <a href="#registrationForm" data-toggle="modal" class="btn btn-lg btn-default btn-block">Create account</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <form role="form" method="POST" action="actions/forgotpassword.php">
                            <fieldset>
                                ...
                                <!-- Change this to a button or input when using this as a form -->
                                <input class="btn btn-lg btn-promo2 btn-block" name="submit" type="submit" value="Submit" />
                                <a href="?" data-toggle="modal" class="btn btn-lg btn-default btn-block">Cancel</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <form role="form" action="actions/regredirect.php" method="post">
                            <fieldset>
                                ...
                                <!-- Change this to a button or input when using this as a form -->
                                <input value="Create an Account" name="submit" type="submit" class="btn btn-lg btn-primary btn-block">
                            </fieldset>
                        </form>
                    </div>
                </div>
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <a href="#petit" class="portfolio-link" data-toggle="modal">
                    <img class="img-responsive img-hover" src="hotelpage/images/rooms/petit (2).jpg" alt="" height="100px" width="460px" >
                </a>
            </div>
            <div class="col-md-6">
                <h3>
                    <a href="blog-post.html">Petit Deluxe</a>
                </h3>
                <p>Expect such amenities and services with your stay: <a href="#"> </a></p>
                <p><ul class="list-bullet">
                <li>Smoking and non-smoking rooms</li>
                <li>Full-size posture-pedic beds</li>
                <li>Full bath with tub</li>
                <li>21-inch cable TV</li>
                <li>Broadband Internet access</li>
                <li>24-hour room service</li>
                <li>Hair dryer and phone</li>
                <li>Daily delivery of local newspaper</li>
                </ul></p>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <a href="#standard" class="portfolio-link" data-toggle="modal">
                    <img class="img-responsive img-hover" src="hotelpage/images/rooms/family standard.jpg" alt="">
                </a>
            </div>
            <div class="col-md-6">
                <h3><a href="blog-post.html">Standard Deluxe</a>
                </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <a href="#full" class="portfolio-link" data-toggle="modal">
                    <img class="img-responsive img-hover" src="hotelpage/images/rooms/full (2).jpg" alt="">
                </a>
            </div>
            <div class="col-md-6">
                <h3><a href="blog-post.html">Full Deluxe</a>
                </h3>
                <p>Expect such amenities and services with your stay: </p>
                <p><ul class="list-bullet">
                <li>Smoking and non-smoking rooms</li>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <a href="#familly" class="portfolio-link" data-toggle="modal">
                    <img class="img-responsive img-hover" src="hotelpage/images/rooms/familly double.jpg" alt="">
                </a>
            </div>
            <div class="col-md-6">
                <h3><a href="blog-post.html">Family Standard</a>
                </h3>
                <p>Expect such amenities and services with your stay: </p>
                <p><ul class="list-bullet">
                <li>Smoking and non-smoking rooms</li>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <a href="#familly2" class="portfolio-link" data-toggle="modal">
                    <img class="img-responsive img-hover" src="hotelpage/images/rooms/familly double2.jpg" alt="">
                </a>
            </div>
            <div class="col-md-6">
                <h3><a href="blog-post.html">Family Double</a>
                </h3>
                <p>Expect such amenities and services with your stay: </p>
                <p><ul class="list-bullet">
                <li>Smoking and non-smoking rooms</li>
    ...
    <!--modal room pictures-->
    <div class="room-modal modal fade" id="petit" tabindex="-1" role="dialog" aria-hidden="true">
        <div style="background-image: url(&quot;hotelpage/images/rooms/petit (2).jpg&quot;); background-size: 100% 100%; background-repeat: no-repeat;" class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                    </div>
    ...
    <div class="room-modal modal fade" id="standard" tabindex="-1" role="dialog" aria-hidden="true">
        <div style="background-image: url(&quot;hotelpage/images/rooms/family standard.jpg&quot;); background-size: 100% 100%; background-repeat: no-repeat;" class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                    </div>
    ...
    <div class="room-modal modal fade" id="full" tabindex="-1" role="dialog" aria-hidden="true">
        <div style="background-image: url(&quot;hotelpage/images/rooms/full (2).jpg&quot;); background-size: 100% 100%; background-repeat: no-repeat;" class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                    </div>
    ...
    <div class="room-modal modal fade" id="familly" tabindex="-1" role="dialog" aria-hidden="true">
        <div style="background-image: url(&quot;hotelpage/images/rooms/familly double.jpg&quot;); background-size: 100% 100%; background-repeat: no-repeat;" class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                    </div>
    ...
    <div class="room-modal modal fade" id="familly2" tabindex="-1" role="dialog" aria-hidden="true">
        <div style="background-image: url(&quot;hotelpage/images/rooms/familly double2.jpg&quot;); background-size: 100% 100%; background-repeat: no-repeat;" class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                    </div>
