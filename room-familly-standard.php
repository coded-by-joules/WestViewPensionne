...
<head>
    ...
    <title>Westview Pensione House - Cebu | Room - Familly Standard </title>
...
<body>
    ...
    <div class="container" style="margin-top:65px;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
               ...
               <p><span class="fa fa-tag " style="color:red;"></span> Smoking and non-smoking rooms</p>
                <p><span class="fa fa-tag " style="color:red;"></span> 2 Family bed size</p>  
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-xs-6">
                <a href="room-familly-duo.php">
                    <img class="img-responsive img-hover img-related" src="hotelpage/images/sliderimages/familly_dou500x300.jpg" alt="">
                </a><label>Familly Double</label>
            </div>
